	...
	return (
		<div className="flex flex-col md:flex-row items-center justify-center mb-4">
			<div className="w-1/3 flex flex-col md:mr-4 mb-4 items-center">
				<img src={heroImage} alt="hImg" className="rounded-2xl w-5/6" />
			</div>
			<div className="w-2/3">
				...
				<p className="text-base mb-6 text-slate-300">
					A recent CS graduate with a focus on web development, dedication to
					lifelong learning, collaborative mindset, and keen attention to
					detail. I am passionate about creating user-friendly web solutions,
					responsive interfaces, optimizing website performance, and building
